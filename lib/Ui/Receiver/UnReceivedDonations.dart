  ...
  Widget build(BuildContext context) {
     ...
     return StatefulWrapper(onInit:(){
       ...
       body: RefreshIndicator(
           ...
           child: Obx(() => ListView.builder(itemCount:controller.donations.length, itemBuilder: (context, index){
             return Padding(
               padding: const EdgeInsets.all(8.0),
               child: InkWell(
                 onTap: (){
                   //log(controller.donations[index].id);
                   Get.to(()=>DonationDetailsScreen(index,"Receiver",donationId: controller.donations[index].id,));
                 },
                 child: Container(
